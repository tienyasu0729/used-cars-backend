...
public interface BookingRepository extends JpaRepository<Booking, Long> {
	...
	@Query("""
			...
			""")
	long countAssignedBookingsAtBranch(@Param("branchId") int branchId);
	...
	@Query("""
			...
			where (
				b.bookingDate < :thresholdDate
				or (b.bookingDate = :thresholdDate and b.timeSlot <= :thresholdTime)
			)
			and b.status in :statuses
			order by b.bookingDate asc, b.timeSlot asc, b.id asc
			""")
	List<Long> findIdsByStatusInAndStartedBeforeThreshold(@Param("thresholdDate") LocalDate thresholdDate,
